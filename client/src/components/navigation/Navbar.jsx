                  ...
                  <DropdownMenuGroup>
                    ...
                    <Link to="/view-past-sessions">
                      <DropdownMenuItem className="mx-1 my-1 rounded-xl px-3 py-3 hover:bg-gradient-to-r hover:from-purple-50 hover:to-purple-100 transition-all duration-200 group">
                        <History className="w-4 h-4 mr-3 text-purple-600 group-hover:text-purple-700" />
                        <span className="font-medium text-gray-700 group-hover:text-gray-900">
                          View Past Sessions
                        </span>
                      </DropdownMenuItem>
                      ...
                      user.isVerified === "verified" && (
                        <>
                          ...
                          <Link to="/admin/manage-schedule">
                            <DropdownMenuItem className="mx-1 my-1 rounded-xl px-3 py-3 hover:bg-gradient-to-r hover:from-cyan-50 hover:to-cyan-100 transition-all duration-200 group">
                              <Calendar className="w-4 h-4 mr-3 text-cyan-600 group-hover:text-cyan-700" />
                              <span className="font-medium text-gray-700 group-hover:text-gray-900">
                                Manage Schedule
                              </span>
                            </DropdownMenuItem>
                          ...
                          <Link to="/admin/manage-bh-family">
                            <DropdownMenuItem className="mx-1 my-1 rounded-xl px-3 py-3 hover:bg-gradient-to-r hover:from-teal-50 hover:to-teal-100 transition-all duration-200 group">
                              <Users className="w-4 h-4 mr-3 text-teal-600 group-hover:text-teal-700" />
                              <span className="font-medium text-gray-700 group-hover:text-gray-900">
                                Manage BH Family
                              </span>
                            </DropdownMenuItem>
