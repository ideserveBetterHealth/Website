...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fffae3]">
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-[#000080] text-center mb-12">
          Privacy Policy
        </h1>
          ...
          <div className="space-y-2">
            {sections.map((section, index) => (
              <div
                ...
                className="cursor-pointer hover:bg-[#fffae3] p-2 rounded flex items-start"
              >
                <span className="text-[#ec5228] font-medium w-6">
                  {index + 1}.
                </span>
                <span className="text-gray-700 hover:text-[#ec5228] flex-1">
                  {section.title}
                </span>
              </div>
            ))}
