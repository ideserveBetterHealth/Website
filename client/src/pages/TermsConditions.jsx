      ...
      <section className="section section-bg-1">
        <div className="container">
          ...
          <div className="terms-content">
            {" "}
            {/* Table of Contents */}
            <section className="terms-section toc">
              ...
              <ul className="toc-list">
                ...
                <li>
                  <a href="#eligibility">Eligibility and User Classification</a>
                  <span className="dots"></span>
                </li>
                <li>
                  <a href="#scope">Scope of Services</a>
                  <span className="dots"></span>
                </li>
                <li>
                ...
                <li>
                  <a href="#payment">Payment, Pricing & Refunds</a>
                  <span className="dots"></span>
                </li>
                <li>
                  <a href="#consultant-responsibilities">
                    Consultant Responsibilities
                  </a>
                  <span className="dots"></span>
                </li>
                <li>
                  <a href="#data-handling">Data Handling & Confidentiality</a>
                  <span className="dots"></span>
                </li>
                <li>
                  <a href="#third-party">
                ...
                <li>
                  <a href="#conduct">User Conduct and Platform Rules</a>
                  <span className="dots"></span>
                </li>
                <li>
                ...
                <li>
                  <a href="#termination">Termination of Services</a>
                  <span className="dots"></span>
                </li>
                <li>
                ...
                <li>
                  <a href="#modification">Modification of Terms</a>
                  <span className="dots"></span>
                </li>
              </ul>
            </section>
            ...
            <section id="definitions" className="terms-section">
              <h2 className="heading-2">2. Definitions</h2>
              <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">a. "Better Health"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">b. "ElevateBiz Group"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">c. "Platform"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">d. "User"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">e. "Services"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">f. "Consultant"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">g. "Session"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">h. "MoM" (Minutes of Meeting)</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">i. "Confidential Information"</h3>
                <p className="body-text">
              ...
              <div className="definition-item">
                <h3 className="heading-3">j. "Third-Party Tools"</h3>
                <p className="body-text">
            ...
            <section id="eligibility" className="terms-section">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. General Eligibility</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">
                  b. Services for Children (Under 18 Years)
                </h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">
                  c. Services for Adults (18 Years and Above)
                </h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Territorial Eligibility</h3>
                <p className="body-text">
            ...
            <section id="scope" className="terms-section">
              <h2 className="heading-2">4. Scope of Services</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Mental Health Counselling</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Cosmetologist Consultations</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Digital Appointment Management</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">e. Modes of Service Delivery</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">f. No Emergency Services</h3>
                <p className="body-text">
            ...
            <section id="user-responsibilities" className="terms-section">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Accurate Information</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Respectful Interaction</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Session Conduct</h3>
                <p className="body-text">You must:</p>
                <ul className="styled-list">
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Parental Supervision</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">e. Use of Platform</h3>
              ...
              <div className="subsection">
                <h3 className="heading-3">f. Confidentiality</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">g. Health Disclaimer</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">h. Payment Compliance</h3>
                <p className="body-text">
            ...
            <section id="payment" className="terms-section">
              <h2 className="heading-2">6. Payment, Pricing & Refunds</h2>

              <div className="subsection">
                <h3 className="heading-3">a. Payment Gateway</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Pricing Model</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Taxes and Charges</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Payment Confirmation</h3>
                <p className="body-text">Upon successful payment:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">e. Failed Transactions</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">f. Refunds and Cancellations</h3>
                <p className="body-text">
                ...
                <p className="body-text">No refund will be issued for:</p>
                <ul className="styled-list">
              ...
              <div className="subsection">
                <h3 className="heading-3">g. Non-Refundable Services</h3>
                <p className="body-text">
            ...
            <section id="consultant-responsibilities" className="terms-section">
              <h2 className="heading-2">7. Consultant Responsibilities</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Independent Service Providers</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Licensing and Qualifications</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Professional Conduct</h3>
                <p className="body-text">Consultants are expected to:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Session Management</h3>
                <p className="body-text">Consultants must:</p>
                <ul className="styled-list">
              ...
              <div className="subsection">
                <h3 className="heading-3">f. Confidentiality Obligations</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">g. Prohibited Conduct</h3>
                <p className="body-text">Consultants are prohibited from:</p>
                <ul className="styled-list">
            ...
            <section id="data-handling" className="terms-section">
              <h2 className="heading-2">8. Data Handling & Confidentiality</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Types of Data Collected</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Storage and Security</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Internal Access</h3>
                <p className="body-text">User data is only accessible by:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">e. Confidentiality in Sessions</h3>
                <ul className="styled-list">
              ...
              <div className="subsection">
                <h3 className="heading-3">f. User Rights</h3>
                <p className="body-text">Users have the right to:</p>
                <ul className="styled-list">
            ...
            <section id="third-party" className="terms-section">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Payment Processing – Cashfree</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Data Collection – Google Forms</h3>
                <p className="body-text">
            ...
            <section id="liability" className="terms-section">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Service Disclaimer</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Professional Qualifications</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. No Guarantees of Outcomes</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Third-Party Tools and Downtime</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">e. Liability Cap</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">f. User Responsibility</h3>
                <p className="body-text">
            ...
            <section id="conduct" className="terms-section">
              <h2 className="heading-2">11. User Conduct and Platform Rules</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Respectful and Ethical Use</h3>
                <p className="body-text">You agree to:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Prohibited Activities</h3>
                <p className="body-text">You must not:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Account Security</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Session Access and Punctuality</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">f. Breach of Conduct</h3>
                <p className="body-text">
            ...
            <section id="intellectual-property" className="terms-section">
              <h2 className="heading-2">12. Intellectual Property</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Ownership</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">b. User Access and Restrictions</h3>
                <p className="body-text">
                ...
                <p className="body-text">You are not allowed to:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Third-Party Content</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">d. User-Generated Content</h3>
                <p className="body-text">
            ...
            <section id="termination" className="terms-section">
              <h2 className="heading-2">13. Termination of Services</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Termination by the User</h3>
                <p className="body-text">
                ...
                <p className="body-text">Please note:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Termination by Better Health</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Consequences of Termination</h3>
                <p className="body-text">Upon termination:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Right to Deny Access</h3>
                <p className="body-text">
            ...
            <section id="governing-law" className="terms-section">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Governing Law</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Jurisdiction</h3>
                <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">c. Dispute Resolution Procedure</h3>
                <p className="body-text">In the event of a dispute:</p>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">d. Arbitration</h3>
                <p className="body-text">
            ...
            <section id="modification" className="terms-section">
              <h2 className="heading-2">15. Modification of Terms</h2>
              <p className="body-text">
              ...
              <div className="subsection">
                <h3 className="heading-3">a. Change Notification</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">b. Continued Use as Consent</h3>
                <ul className="styled-list">
                  <li>
              ...
              <div className="subsection">
                <h3 className="heading-3">
                  c. Responsibility to Stay Informed
                </h3>
                <p className="body-text">
