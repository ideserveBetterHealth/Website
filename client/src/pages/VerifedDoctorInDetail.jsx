        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-black-800 mt-2">
                Verified
              </span>
            </div>
          </div>
...
export default VerifiedDoctorInDetail;
