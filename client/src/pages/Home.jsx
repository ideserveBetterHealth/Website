      ...
      >
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 justify-center items-stretch mt-12 px-4">
            <div className="bg-white rounded-2xl shadow-lg p-8 flex-1 max-w-lg min-w-80 flex flex-col items-center transition-all duration-300 gap-6 hover:-translate-y-2 hover:shadow-2xl">
              {" "}
              <img
              ...
              />
              <h3 className="text-[#000080] text-xl font-bold mb-4 tracking-tight">
      ...
      >
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8 justify-items-center">
            <div className="bg-white p-8 rounded-xl text-center shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-lg w-3/4 md:w-full">
              <div className="text-4xl mb-4 inline-block">👨‍⚕️</div>
              <h3 className="text-[#000080] text-lg font-bold mb-3 tracking-tight">
