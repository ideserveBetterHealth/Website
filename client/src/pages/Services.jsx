  ...
  return (
    <div className="page">
      ...
      <section className="section section-bg-2">
        <div className="container">
          <div className="service-image mb-8">
            <img
              src={import.meta.env.BASE_URL + "mental-health-consultation.png"}
              alt="Mental Health Counselling Session"
              className="service-detail-image w-full max-w-2xl mx-auto rounded-lg shadow-lg"
            />
          </div>
          <div className="service-content text-center">
            <h2 className="section-title">Mental Health Counselling</h2>
            <p className="body-text">
              Our mental health counseling services provide professional support
              for various emotional and psychological challenges. Our
              professional therapists offer:
            </p>
            <ul className="service-list text-left max-w-2xl mx-auto">
      ...
      <section className="section section-bg-1">
        <div className="container">
          ...
          <div className="service-content text-center">
            ...
            <p className="body-text">
              Our certified cosmetologists provide expert guidance for all your
              skincare and beauty needs. Our services include:
            </p>
            <ul className="service-list text-left max-w-2xl mx-auto">
